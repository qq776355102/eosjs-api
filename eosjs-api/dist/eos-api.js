...
function fetchMethod(methodName, url, definition, config) {
  ...
  return function () {
    ...
    var result = post(fetchConfiguration);
    console.log(result);
    return result;
...
function post(options){
  return request(options.method,options.url,options.body);
}
...
},{"./exported-helpers":5,"./process-args":7,"camel-case":8,"isomorphic-fetch":10,"sync-request":21}],5:[function(require,module,exports){
'use strict';
...
},{"no-case":12,"upper-case":23}],9:[function(require,module,exports){
"use strict";
/**
...
},{"whatwg-fetch":24}],11:[function(require,module,exports){
/**
...
},{"./vendor/camel-case-regexp":13,"./vendor/camel-case-upper-regexp":14,"./vendor/non-word-regexp":15,"lower-case":11}],13:[function(require,module,exports){
...
},{"http-response-object":9,"then-request/lib/handle-qs.js":22}],22:[function(require,module,exports){
"use strict";
exports.__esModule = true;
var qs_1 = require("qs");
...
},{"qs":17}],23:[function(require,module,exports){
/**
 * Special language-specific overrides.
 *
 * Source: ftp://ftp.unicode.org/Public/UCD/latest/ucd/SpecialCasing.txt
